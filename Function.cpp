...
void Test_Message(int argc, char* argv[]) {
    if (argc != 2) 
        cout << "参数错误!" << endl;
    vector<string> str = { "", "a", "abc", "message digest", "abcdefghijklmnopqrstuvwxyz", "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", "12345678901234567890123456789012345678901234567890123456789012345678901234567890","南开大学津南校区DMY!" };
    MD5 md5;
